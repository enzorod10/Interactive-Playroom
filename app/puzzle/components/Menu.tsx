...
export default function Menu() {
    ...
    if (rowsAndCols){
        ...
        return (
            <div className="h-[calc(100dvh-48px)] overflow-auto max-w-screen-2xl py-4 flex flex-col items-center sm:justify-center gap-4">
                    ...
                    {[2, 4, 6, 8, 10, 12].map(num => {
                        return(
                            <div onClick={() => setRowsAndCols(num)} key={num} className='flex relative flex-col cursor-pointer justify-center items-center gap-2'>
                                ...
                                <div className="border border-2 border-zinc-500 rounded-lg p-4 shadow-md">
